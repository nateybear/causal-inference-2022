...
-   You should always strive to keep your software updated to the latest stable version...
...
-   You will need to create an account with GitHub and configure `git` with your GH credentials
    - The accepted way to do this has changed a lot over the past few years
    - Comprehensive documentation [here](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/about-authentication-to-github) on authentication
...
- Typesetting software, plain text as opposed to the WYSIWYG style of Word
...
## A Word of Warning | Don't Save Workspace Data
